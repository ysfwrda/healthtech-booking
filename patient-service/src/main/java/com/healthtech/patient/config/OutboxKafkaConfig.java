...
// JsonSerializer-based KafkaTemplate beans. The relay publishes payloads that are already
// serialized JSON strings, so it needs a plain String value serializer. Changing the global
// spring.kafka.producer.value-serializer instead would break other typed producers.
@Configuration
